...
const defaultBloodT = {
    ...
    shareNote:
        'Si vous ne pouvez pas donner, merci de partager cette demande avec votre entourage. Chaque partage peut aider à sauver une vie.',
    unsubscribe: 'Se désabonner',
    unsubscribePrompt:
        'Vous ne souhaitez plus recevoir de notifications pour les demandes urgentes de sang ?',
    autoSent:
