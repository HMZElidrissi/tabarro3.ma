...
const defaultT = {
    ...
    preview:
        'Réinitialisez votre mot de passe tabarro3 — ce lien expire dans 60 minutes',
    ...
    expiryNote:
        'Pour des raisons de sécurité, cette demande expirera dans 60 minutes. Après ce délai, vous devrez soumettre une nouvelle demande.',
    ignoreNote:
