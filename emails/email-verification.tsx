...
const defaultT = {
    ...
    bodyThanks:
        'Merci de rejoindre tabarro3, la plateforme dédiée à la sensibilisation et à la promotion du don de sang au Maroc.',
    bodyConfirm:
        'Pour finaliser la création de votre compte et accéder à toutes les fonctionnalités, veuillez confirmer votre adresse e-mail en cliquant sur le bouton ci-dessous.',
    cta: 'Confirmer mon e-mail',
    securityNote:
        "Pour des raisons de sécurité, ce lien expirera dans 24 heures. Si vous n'êtes pas à l'origine de cette inscription, vous pouvez ignorer cet e-mail.",
};
