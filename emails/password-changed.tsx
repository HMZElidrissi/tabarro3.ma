...
const defaultT = {
    ...
    preview:
        "Votre mot de passe a été modifié — ce n'était pas vous ? Contactez-nous immédiatement",
    title: 'Mot de passe modifié avec succès',
    greeting: 'Bonjour,',
    body: 'Cet email confirme que votre mot de passe a été modifié avec succès.',
    contactNote:
        "Si vous n'êtes pas à l'origine de ce changement, veuillez contacter notre équipe support immédiatement :",
