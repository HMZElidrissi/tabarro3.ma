...
export default function Footer({ dict, isRTL = false }: FooterProps) {
    return (
        <footer className="relative border-t bg-gradient-to-br from-brand-600 via-brand-700 to-brand-800">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-12 sm:py-16 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-8 sm:mb-12">
                    ...
                    <div className="flex flex-col items-center md:items-start space-y-6">
                        ...
                        <Image
                            ...
                            width={500}
                            height={500}
                            className="w-auto h-24 sm:h-28 lg:h-36 mx-auto md:mx-0"
                        />
                        ...
                        <div className="flex items-center justify-center md:justify-start gap-3 sm:gap-4">
                            <SocialIcon
                                ...
                                size={6}
                                className="text-white hover:text-[#EA4335] transition-all duration-300 hover:scale-110"
                            />
                            <SocialIcon
                                kind="facebook"
                                href="https://www.facebook.com/tabarro3maroc/"
                                size={6}
                                className="text-white hover:text-[#4267B2] transition-all duration-300 hover:scale-110"
                            />
                            <SocialIcon
                                kind="instagram"
                                href="https://www.instagram.com/tabarro3_ma/"
                                size={6}
                                className="text-white hover:text-[#E1306C] transition-all duration-300 hover:scale-110"
                            />
                            <SocialIcon
                                kind="twitter"
                                href="https://x.com/tabarro3_ma"
                                size={6}
                                className="text-white hover:text-[#1DA1F2] transition-all duration-300 hover:scale-110"
                            />
                        </div>
                    </div>
                ...
                <div className="pt-6 sm:pt-8 border-t border-white/20">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
                        {/* Copyright */}
                        <p className="order-2 sm:order-1 text-white/70 text-xs sm:text-sm">
                        ...
                        <a
                            ...
                            className="order-1 sm:order-2 inline-flex items-center gap-1.5 text-white/70 hover:text-white transition-colors duration-300 text-sm font-medium group">
                            <svg
